...
export const getEmmaTranscribeUrl = () => {




  return `/api/emma/transcribe`
}

/**
 * @summary Transcribe audio to text using Whisper
 */
export const emmaTranscribe = async (emmaTranscribeInput: EmmaTranscribeInput, options?: RequestInit): Promise<EmmaTranscribeOutput> => {

  return customFetch<EmmaTranscribeOutput>(getEmmaTranscribeUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getEmmaTranscribeMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof emmaTranscribe>>, TError,{data: BodyType<EmmaTranscribeInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof emmaTranscribe>>, TError,{data: BodyType<EmmaTranscribeInput>}, TContext> => {

const mutationKey = ['emmaTranscribe'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof emmaTranscribe>>, {data: BodyType<EmmaTranscribeInput>}> = (props) => {
          const {data} = props ?? {};

          return  emmaTranscribe(data,requestOptions)
        }
 ...
 * @summary Transcribe audio to text using Whisper
 */
export const useEmmaTranscribe = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof emmaTranscribe>>, TError,{data: BodyType<EmmaTranscribeInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof emmaTranscribe>>,
        TError,
        {data: BodyType<EmmaTranscribeInput>},
        TContext
      > => {
      return useMutation(getEmmaTranscribeMutationOptions(options));
    }

export const getEmmaSpeakUrl = () => {




  return `/api/emma/speak`
}

/**
 * @summary Convert text to speech using OpenAI TTS
 */
export const emmaSpeak = async (emmaSpeakInput: EmmaSpeakInput, options?: RequestInit): Promise<EmmaSpeakOutput> => {

  return customFetch<EmmaSpeakOutput>(getEmmaSpeakUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getEmmaSpeakMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof emmaSpeak>>, TError,{data: BodyType<EmmaSpeakInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof emmaSpeak>>, TError,{data: BodyType<EmmaSpeakInput>}, TContext> => {

const mutationKey = ['emmaSpeak'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof emmaSpeak>>, {data: BodyType<EmmaSpeakInput>}> = (props) => {
          const {data} = props ?? {};

          return  emmaSpeak(data,requestOptions)
        }
 ...
 * @summary Convert text to speech using OpenAI TTS
 */
export const useEmmaSpeak = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof emmaSpeak>>, TError,{data: BodyType<EmmaSpeakInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof emmaSpeak>>,
        TError,
        {data: BodyType<EmmaSpeakInput>},
        TContext
      > => {
      return useMutation(getEmmaSpeakMutationOptions(options));
    }

export const getEmmaSearchUrl = () => {




  return `/api/emma/search`
}

/**
 * @summary Web search with page content extraction
 */
export const emmaSearch = async (emmaSearchInput: EmmaSearchInput, options?: RequestInit): Promise<EmmaSearchOutput> => {

  return customFetch<EmmaSearchOutput>(getEmmaSearchUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getEmmaSearchMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof emmaSearch>>, TError,{data: BodyType<EmmaSearchInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof emmaSearch>>, TError,{data: BodyType<EmmaSearchInput>}, TContext> => {

const mutationKey = ['emmaSearch'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof emmaSearch>>, {data: BodyType<EmmaSearchInput>}> = (props) => {
          const {data} = props ?? {};

          return  emmaSearch(data,requestOptions)
        }
 ...
 * @summary Web search with page content extraction
 */
export const useEmmaSearch = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof emmaSearch>>, TError,{data: BodyType<EmmaSearchInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof emmaSearch>>,
        TError,
        {data: BodyType<EmmaSearchInput>},
        TContext
      > => {
      return useMutation(getEmmaSearchMutationOptions(options));
    }

export const getEmmaDeeplinkUrl = () => {




  return `/api/emma/deeplink`
}

/**
 * @summary Parse app intent and return deep link URL
 */
export const emmaDeeplink = async (emmaDeeplinkInput: EmmaDeeplinkInput, options?: RequestInit): Promise<EmmaDeeplinkOutput> => {

  return customFetch<EmmaDeeplinkOutput>(getEmmaDeeplinkUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getEmmaDeeplinkMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof emmaDeeplink>>, TError,{data: BodyType<EmmaDeeplinkInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof emmaDeeplink>>, TError,{data: BodyType<EmmaDeeplinkInput>}, TContext> => {

const mutationKey = ['emmaDeeplink'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof emmaDeeplink>>, {data: BodyType<EmmaDeeplinkInput>}> = (props) => {
          const {data} = props ?? {};

          return  emmaDeeplink(data,requestOptions)
        }
 ...
 * @summary Parse app intent and return deep link URL
 */
export const useEmmaDeeplink = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof emmaDeeplink>>, TError,{data: BodyType<EmmaDeeplinkInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof emmaDeeplink>>,
        TError,
        {data: BodyType<EmmaDeeplinkInput>},
        TContext
      > => {
      return useMutation(getEmmaDeeplinkMutationOptions(options));
    }
